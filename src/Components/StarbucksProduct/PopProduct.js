const PopProduct = [
  {
    ...
    summary: 'Everybody’s favourite indulgence. Crafted expertly with premium espresso, blended with milk, and perfected with a hint of vanilla in every sip.',
    price: '₹ 336.00'
  },
  {
    id: 2,
    type: 'veg-item',
    typeUrl: 'https://www.starbucks.in/assets/icon/veg.svg',
    imgUrl: 'https://starbucksstatic.cognizantorderserv.com/Items/Large/webP/100501.webp',
    ...
    summary: 'Mocha sauce and Frappuccino® chips blended with with Frappuccino® roast coffee and milk and ice, then topped with whipped vanilla topping and mocha drizzle to bring you endless java joy.',
    price: '₹ 409.50'
  },
  {
    id:3,
    type: 'veg-item',
    typeUrl:'https://www.starbucks.in/assets/icon/veg.svg',
    imgUrl:'https://starbucksstatic.cognizantorderserv.com/Items/Large/webP/100433.webp',
    title: 'Caffe Americano',
     content:[
        {img1:'https://starbucksstatic.cognizantorderserv.com/Icon/Dark/Milk.png',name:'MILK'},
    ],
    info: 'SHORT(237 mL) .0 kcal',
    summary: 'Rich in flavour, full-bodied espresso with hot water in true European style.',
    price: '₹ 283.50'
  },
  { 
    id:4,
    type: 'veg-item',
    typeUrl:'https://www.starbucks.in/assets/icon/veg.svg',
    imgUrl:'https://starbucksstatic.cognizantorderserv.com/Items/Large/webP/100419.webp',
    title: 'Cappuccino',
     content:[
        {img1:'https://starbucksstatic.cognizantorderserv.com/Icon/Dark/Milk.png',name:'MILK'},
    ],
    info: 'SHORT(237 ml) .104 kcal',
    summary: 'Dark, Rich in flavour espresso lies in wait under a smoothed and stretched layer of thick foam. It&#39;s truly the height of our baristas&#39; craft.',
    price: '₹ 299.25'
  },
  { 
    id:5,
